...
try {
$sql="SELECT post.caption,post.Active_name,post.created_at,post.descrt,users.username,users.profile_photo_url,
photos.photo_url FROM post 
JOIN users ON post.user_id=users.user_id 
JOIN photos ON post.post_id=photos.post_id";
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="main">
            ...
            <!-- Post -->
            <?php
			require "../post/showpost/showpost2.php";
							?>
