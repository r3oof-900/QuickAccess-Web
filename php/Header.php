...
<body>
    <header id="header">
        ...
        <nav class="links">
            <ul>
                <li><a href="php/pages/1.php">Technical Services</a></li>
                <li><a href="php/pages/2.php">Health Services</a></li>
                <li><a href="php/pages/3.php">Car Services</a></li>
                <li><a href="php/pages/4.php">University Services</a></li>
                <li><a href="php/pages/5.php">Household Services</a></li>
            </ul>
        </nav>
        <nav class="main">
            <ul>
